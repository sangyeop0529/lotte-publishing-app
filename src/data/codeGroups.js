  ...
  <div class="toggle-box__con">
    <img src="./images/contents.jpg" alt="" />
      ...
      },
      {
        language: "css",
        code: `/* toggle.css */
.toggle-box .toggle-box__btns {
  position: relative;
}
.toggle-box .toggle-box__btns::before {
  content: "";
  position: absolute;
  top: 50%;
...
.toggle-box .toggle-box__btns::before {
  ...
  width: 2.6667vw;
  height: 1.6vw;
  background: url("../images/t-arrow.png") no-repeat center/contain;
}
.toggle-box.on .toggle-box__btns::before {
