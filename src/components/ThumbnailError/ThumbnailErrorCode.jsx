...
import "./ThumbnailErrorCode.css";
import codeClass from "../../data/thumbnailErrorData";
import { useState } from "react";

const ThumbnailErrorCode = () => {
  ...
  return (
    <div className="ThumbnailErrorCode">
      <div className="container">
        {codeClass.map((item, idx) => (
...
export default ThumbnailErrorCode;
